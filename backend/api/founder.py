...
async def get_founder_metrics(authorized: bool = Depends(verify_founder_password)):
    ...
    try:
        ...
        return {
            ...
            "critical_alerts": "No critical alerts. All systems sovereign." if neural_states.get("crisis", 0) == 0 else f"⚠️ {neural_states.get('crisis', 0)} users detected in CRISIS state"
        }
