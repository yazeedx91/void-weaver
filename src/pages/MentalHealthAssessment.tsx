...
import { mentalHealthQuestions } from '@/data/questions';
...
export default function MentalHealthAssessment() {
  ...
  const questions = mentalHealthQuestions.questions;
      ...
      <AssessmentVessel>
        <div className="space-y-6">
          <div className="text-center space-y-2">
            <motion.span
              className="text-xs font-display uppercase tracking-widest text-crimson-glow"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            >
              {mentalHealthQuestions.description}
            </motion.span>
            <motion.p
